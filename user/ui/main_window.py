...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionview_saved_doctors.triggered.connect(lambda: self.Clicked(dbms.get_saved_doctors(create_connection("db.sqlite"),dbms.current_logged_in)))
        self.actionadd_saved_doctors.triggered.connect(lambda :self.open_search_doctors_window())
        self.follow_btn.clicked.connect(lambda : self.Clicked(dbms.follow_appointment_info(create_connection("db.sqlite"),id, dbms.current_logged_in)))
